...
- [Bootstrap 5](https://getbootstrap.com/) (dark theme) for styling, loaded via CDN
...
|-------------------|------------------|------------------------------------------------------------------------|
| `HDHOMERUN_HOST`  | `hdhomerun.local`| **Use your device's LAN IP, not its `.local` mDNS name.** Containers on the default Docker bridge network can't resolve mDNS names. |
